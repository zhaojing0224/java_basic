 ...
 * @author user
 */
public class PayrollLedger extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("会社事務労務会計システム－賃金台帳管理 ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PayrollLedger.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
